 ...
 * AgendaEventForm
 */
class AgendaEventForm extends TWindow
{
    protected $form;
    ...
    public function __construct()
    {
        ...
        $this->form->addFields( [new TLabel('Hr início')], [$start_date, $start_hour, ':', $start_minute] );
        $this->form->addFields( [new TLabel('Hr término')], [$end_date, $end_hour, ':', $end_minute] );
    ...
    public function onSave()
    {
        try
        {
            ...
            $object->profile_id = TSession::getValue('profileid');
            ...
            TTransaction::close(); 
            $posAction = new TAction(array('AgendaViewForm', 'onReload'));
    ...
    public function onEdit($param)
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                // open a transaction with database _DATABASE_
                TTransaction::open(_DATABASE_);
                
                // instantiates object SysAgenda
                $object = new SysAgenda($key);
    ...
    public static function onDelete($param)
    {
        ...
        $action = new TAction(array('AgendaEventForm', 'Delete'));
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            // instantiates object
            $object = new SysAgenda($key, FALSE);
            ...
            $posAction = new TAction(['AgendaViewForm', 'onReload']);
