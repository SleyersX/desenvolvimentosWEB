...
class SystemSharedDocumentList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $category_id = new TDBCombo('category_id', _COMMUNICATION_, 'SystemDocumentCategory', 'id', 'name');
    ...
    public function onDownload($param)
    {
        try
        {
            if (isset($param['id']))
            {
                ...
                TTransaction::open(_COMMUNICATION_); // open a transaction
    ...
    public function onReload($param = NULL)
    {
        try
        {
            // open a transaction with database _COMMUNICATION_
            TTransaction::open(_COMMUNICATION_);
