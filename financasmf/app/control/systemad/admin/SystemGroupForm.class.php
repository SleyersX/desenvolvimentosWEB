...
class SystemGroupForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle( 'Grupos de Permissões' );

        // create the form fields
        $id   = new TEntry('id');
        $name = new TEntry('name');
        $program_id = new TDBSeekButton('program_id', _PERMISSION_, 'form_System_group', 'SystemProgram', 'name', 'program_id', 'program_name');
