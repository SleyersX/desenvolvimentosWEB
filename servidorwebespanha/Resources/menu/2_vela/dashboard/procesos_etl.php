...
//			if (SoyYo()) { echo "<pre>"; print_r($d); echo "</pre>"; }
		}
	}
}
...
?>
<style>
	#tabla_general { width:100%; height:100%; }
	#tabla_general td { vertical-align: top; }
...
<body>
	<div>
		<table id="tabla_general" style="width:100%; height:100%; vertical-align: top;">
			...
			<tr class="jobs_etl" style="display:none"><td colspan="3">
				<span style="display:block; text-align: center; margin-bottom: 10px; background: whitesmoke;">Listado de errores en inicio de día</span><div id='tabla_ko_jobs'></div>
			</td></tr>
		</table>
	</div>
</body>
...
<script>
	...
	function pinta_resultados_hoy() {
		...
		$("#end_day_ok").html(data2_etl.og[data2_etl.getNumberOfRows()-1].c[1].v+data2_etl.og[data2_etl.getNumberOfRows()-2].c[1].v);
		$("#end_day_ko").html(data2_etl.og[data2_etl.getNumberOfRows()-1].c[2].v+data2_etl.og[data2_etl.getNumberOfRows()-2].c[2].v);
