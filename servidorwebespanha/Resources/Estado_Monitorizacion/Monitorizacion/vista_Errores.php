...
$Queries["EBD"]=array ("ERRORES EN BASE DE DATOS (HOY)",
	...
	"select EBD.Tienda, EBD.Caja, a.centro, c.Version, TIME(EBD.Fecha), EBD.Error from EBD join tmpTiendas a ON EBD.Tienda=a.numerotienda join $Table c ON c.Tienda=EBD.Tienda AND c.Caja=EBD.Caja WHERE DATE(EBD.Fecha)=DATE(NOW()) order by EBD.Error,EBD.Fecha",
	NULL,
	"ESP",
