...
$tmp=shell_exec("cd $DIR_SCRIPTS; sudo bash get_oper.sh GET_STAT");
$lista = explode("\n",$tmp);
...
$Lista_Operaciones.='</table>';
// $Lista_Operaciones_Web.='</table>';  
	...
	<tr>
		...
		<td id="lista_operaciones" style="display:none" rowspan="2">
			<table>
				...
				<tr><td>'.$Lista_Operaciones.'</td><td></td></tr></table></td>
	</tr>
</tbody>
</table>
<script>
