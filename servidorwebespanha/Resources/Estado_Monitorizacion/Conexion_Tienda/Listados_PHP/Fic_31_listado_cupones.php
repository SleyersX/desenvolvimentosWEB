	...
	echo '
		<div id="Info">
			...
			<div id="info_articulo" style="float:left; margin-left:1em; border:1px solid black; border-radius:3px; padding:1em; background-color:azure">
				<span style="background-color:lightgreen; font-size:12px; font-weight:bold;">&#9664 Haga click en un cupon para ver sus datos.</span>
			</div>
		</div>';
?>
...
<script>
	...
	var Titulo="LISTADO DE REDENCION DE CUPONES";
	
	Desbloqueo();
	
	<?php require_once("library/list_cupo.js"); ?>
