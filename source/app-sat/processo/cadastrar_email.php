<?php
    ...
    $email = filter_input(INPUT_POST, 'email-alarme', FILTER_SANITIZE_STRING);
    $status = filter_input(INPUT_POST, 'cb_active_email', FILTER_SANITIZE_STRING);
    
    $existActiveEmail = "SELECT COUNT(id) AS total_registros FROM tb_email_alarmes WHERE email LIKE '$email'";
    ...
    if($rowExistActiveEmail["total_registros"] >= 1){
        $sqlIdActiveEmail = "SELECT id, email_verificado FROM tb_email_alarmes WHERE email LIKE '$email'";
        ...
        $updateActiveEmail = "UPDATE tb_email_alarmes SET status_email = '$status' WHERE email LIKE '$email'";
        ...
        $sqlNewEmail = "INSERT INTO tb_email_alarmes (email, status_email, email_verificado) VALUES ('$email', '$status',0)";
