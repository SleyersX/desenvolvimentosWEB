<?php
    ...
    if($x==1){
        $sqlDadosFiscais = "SELECT loja, persFisc, direFisc, codiPostFisc, locaFisc, provFisc, inscEstaClie, codiEstaClie, barrClie, numeDireClie, codiIden, codiMuniClie, email, regiao, divisao, centro, n_tpvs_setvari, iploja FROM ". DATA_CONFIG_BD["cn_tab_list_lojas_fechada_completo"] ." WHERE loja LIKE '".$rowDadosSat['loja']."'";
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview  menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="tables/tb-sats-inativos.php?token=<?php echo $token;?>" class="nav-link active">
                            ...
                            <div class="col-md-3">
                                <div class="card card-primary card-outline">
                                    <div class="text-center">
                                        <?php 
                                            if($x>=1){
                                                echo '<div class="small-box bg-secondary">';
                                                    echo '<div class="inner">';
                                                        echo '<h3>'.$rowDadosSat['sat'].'</h3>';
                                                        echo '<p>'.$rowDadosSat['modelo_sat'].'</p>';
                                                        echo '<p><h3>'.strtoupper($rowDadosSat['status']).'</h3></p>';
                                                    echo '</div>';
                                                    echo '<div class="icon">';
                                ...
                                <div class="card">
                                    <div class="card-header p-2">
                                        <ol class="float-sm-right">
                                            <a href="tables/tb-sats-inativos.php?token=<?php echo $token;?>">
                                                ...
                                                <form class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="text" class="form-control" id="estadoOper" value="<?php print $estadoOperacional;?>" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
