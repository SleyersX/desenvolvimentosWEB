                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="load" style="display: none;" id="div-loading"><p align="center"><img src="../dist/img/loading.gif" width="48" height="48"></p></div>
                            </div>
                            <div class="col-sm-4">
                            </div>
                        </div>
                    ...
                    <div class="content">
                        <div class="container-fluid">
                            <div class="row" style="display: none;" id="div-charts-0">
                                <div class="col-sm-6">
                                    <div class="table-responsive-sm">
                                        <table id="tbDataCertificadoSAT" class="table table-sm table-hover table-bordered text-sm table-striped">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>S&#64;T</th>
                            ...
                            <div class="row" style="display: none;" id="div-charts-2">
                                <div class="col-sm-12">
                                    <div class="table-responsive-sm">
                                        <table id="tbDadosGerais" class="table table-sm table-hover table-bordered text-sm table-striped">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>S&#64;T</th>
