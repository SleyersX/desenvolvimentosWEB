<?php
    ...
    */
    function insert_log_III($idUserLog,$nomeUserLog,$loginUserLog,$appLog,$dataLog,$logDados){
        $user="root";
        $passwd="diabrasil";
        $host="localhost";
        $banco="srvremoto";
        ...
        $sqlInsertLog = "INSERT INTO tb_log_email_auto (id_user, nome_user, login_user, aplicacao, data_log, log_dados) VALUES ('$idUserLog','$nomeUserLog','$loginUserLog','$appLog','$dataLog','$logDados')";
