        ...
        <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="tb-comun-sefaz.php?token=<?php echo $token;?>" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-12">
                            <div class="load" style="display: block;" id="div-preloaderc"><img src="../../dist/img/preloader.gif" width="48" height="48"></div>
                            <div class="card" id="div-comunicacao" style="display: none;">
                                <div class="card-header">
                                    <h3 class="card-title">S&#64;Ts com última comunicação com a SEFAZ maior que 5 dias</h3>
                                    <div class="card-tools">
                                        <a href="../../export/export_sat_comun_sefaz.php?errsefaz=err_comun_sefaz" class="btn btn-tool btn-sm">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive-sm">
                                        <table id="tbComunSefaz" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Loja</th>
                                                    ...
                                                    <th>Dias s/ comunicar</th>
                                                    <th>IP Loja</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbodyComunSefaz"></tbody>
                                        </table>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="load" style="display: block;" id="div-preloadert"><img src="../../dist/img/preloader.gif" width="48" height="48"></div>
                            <div class="card" id="div-transmissao" style="display: none;">
                                <div class="card-header">
                                    <h3 class="card-title">S&#64;Ts com última transmissão para a SEFAZ maior que 5 dias</h3>
                                    <div class="card-tools">
                                        <a href="../../export/export_sat_transm_sefaz.php?errsefaz=err_transm_sefaz" class="btn btn-tool btn-sm">
                                            <i class="fas fa-download"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive-sm">
                                        <table id="tbTransmSefaz" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Loja</th>
                                                    ...
                                                    <th>Disco Usado</th>
                                                    <th>Status WAN</th>
                                                    <th>Transmissão SEFAZ</th>
                                                    <th>Dias s/ comunicar</th>
                                                    <th>IP Loja</th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbodyTransmSefaz"></tbody>
                                        </table>
                                    </div>
                                </div>
                            </div>
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    success: function(data){
                        if(data){
                            $('#div-preloaderc').css("display","none")
                            $('#div-comunicacao').css("display","block")
                            for(var i=0;data.length>i;i++){
                                $('#tbodyComunSefaz').append('<tr><td>'+(i+1)+'</td><td>DIA-'+data[i].loja+'</td><td>'+data[i].caixa+'</td><td><a href="../getsat.php?token=<?php echo $token;?>&idsat='+data[i].sat+'&page=d57ea0157f4fb499069258c46c5e258d">'+data[i].sat+'</a></td><td>'+data[i].disco_usado+'</td><td>'+data[i].status_wan+'</td><td>'+data[i].data_hora_comun_sefaz+'</td><td>'+data[i].n_dias+'</td><td>'+data[i].iploja+'</td></tr>')
                            }
                            $(function () {
                                $('#tbComunSefaz').DataTable({
                                    "paging": true,
                                    "lengthChange": true,
                                    "searching": true,
                                    "ordering": true,
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if(data){
                            $('#div-preloadert').css("display","none")
                            $('#div-transmissao').css("display","block")
                            for(var i=0;data.length>i;i++){
                                $('#tbodyTransmSefaz').append('<tr><td>'+(i+1)+'</td><td>DIA-'+data[i].loja+'</td><td>'+data[i].caixa+'</td><td><a href="../getsat.php?token=<?php echo $token;?>&idsat='+data[i].sat+'&page=d57ea0157f4fb499069258c46c5e258d">'+data[i].sat+'</a></td><td>'+data[i].disco_usado+'</td><td>'+data[i].status_wan+'</td><td>'+data[i].data_hora_transm_sefaz+'</td><td>'+data[i].n_dias+'</td><td>'+data[i].iploja+'</td></tr>')
                            }
                            $(function () {
                                $('#tbTransmSefaz').DataTable({
                                "paging": true,
                                "lengthChange": true,
                                "searching": true,
                                "ordering": true,
