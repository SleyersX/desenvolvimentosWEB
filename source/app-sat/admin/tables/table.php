            ...
            <div class="content-wrapper">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Todos os S&#64;Ts</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                ...
                <section class="content">
                    <div class="row">
                        ...
                        <div class="col-sm-4"></div>
                        <div class="card col-sm-12" id="div-table" style="display: none;">
                            <div class="card-header">
                                <h3 class="card-title">Relação de todos os S&#64;Ts</h3>
                                <div class="card-tools">
                                    <a href="../../export/export_sat.php" class="btn btn-tool btn-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive-sm">
                                    <table id="tbDadosGerais" class="table table-bordered table-hover">
                                        ...
                                        <tbody id="tbodyDadosGerais"></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                    ...
                    success: function(data){
                        if(data){
                            ...
                            for(var i=0;data.length>i;i++){
                                $('#tbodyDadosGerais').append('<tr><td>'+(i+1)+'</td><td>DIA-'+data[i].loja+'</td><td>'+data[i].caixa+'</td><td><a href="../getsat.php?token=<?php echo $token;?>&idsat='+data[i].sat+'&page=874409f0e07176e9ca2e8fe4877f13cb">'+data[i].sat+'</a></td><td>'+data[i].disco_usado+'</td><td>'+data[i].data_hora_comun_sefaz+'</td><td>'+data[i].layout+'</td><td>'+data[i].firmware+'</td><td>'+data[i].ip+'</td></tr>')
                            }
                            ...
                            $(function () {
                                ...
                                }).buttons().container().appendTo('#tbDadosGerais_wrapper .col-md-6:eq(0)');
                            });
                        }else{
                            $(function () {
                                $('#tbDadosGerais').DataTable({
