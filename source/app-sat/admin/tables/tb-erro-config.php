                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="tb-erro-config.php?token=<?php echo $token;?>" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Erros de Configurações</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="home.php?token=<?php echo $token;?>">Home</a></li>
                                    <li class="breadcrumb-item active">Erros de Configurações</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="card" id="div-erroconfig" style="display: none;">
                                <div class="card-header">
                                    <h3 class="card-title">S&#64;Ts com IPs distintos do número do caixa</h3>
                                    <div class="card-tools">
                                        <a href="../../export/export_sat_config.php?errip=err_ip" class="btn btn-tool btn-sm">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive-sm">
                                        <table id="tbErroConfig" class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Loja</th>
                                            ...
                                            <tbody id="tbodyErroConfig"></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                        <div class="card" id="div-stwan" style="display: none;">
                            <div class="card-header">
                                <h3 class="card-title">S&#64;Ts com a porta WAN desconectada</h3>
                                <div class="card-tools">
                                    <a href="../../export/export_sat_st_wan.php?errwan=err_wan" class="btn btn-tool btn-sm">
                                        <i class="fas fa-download"></i>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive-sm">
                                    <table id="tbStWan" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Loja</th>
                ...
                success: function(data){
                    if(data){
                        for(var i=0;data.length>i;i++){
                            $('#tbodyStWan').append('<tr><td>'+(i+1)+'</td><td>DIA-'+data[i].loja+'</td><td>'+data[i].caixa+'</td><td><a href="../getsat.php?token=<?php echo $token;?>&idsat='+data[i].sat+'&page=90ddb39c86c34511f23b26c39448a4e4">'+data[i].sat+'</a></td><td>'+data[i].disco_usado+'</td><td>'+data[i].status_wan+'</td><td>'+data[i].ipsat+'</td><td>'+data[i].iploja+'</td></tr>')
                        }
                        $(function () {
                            $("#tbStWan").DataTable({
                                "paging": true,
            ...
            $.ajax({
                ...
                success: function(data){
                    if(data){
                        ...
                        $('#div-erroconfig').css("display","block")
                        $('#div-stwan').css("display","block")
                        for(var i=0;data.length>i;i++){
                            $('#tbodyErroConfig').append('<tr><td>'+(i+1)+'</td><td>DIA-'+data[i].loja+'</td><td>'+data[i].caixa+'</td><td><a href="../getsat.php?token=<?php echo $token;?>&idsat='+data[i].sat+'&page=90ddb39c86c34511f23b26c39448a4e4">'+data[i].sat+'</a></td><td>'+data[i].ip+'</td><td>'+data[i].IPLoja+'</td></tr>')
                        }
                        $(function () {
                            $('#tbErroConfig').DataTable({
                                "paging": true,
                                "lengthChange": true,
                                "searching": true,
                                "ordering": true,
