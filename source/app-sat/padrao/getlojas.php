<?php
    ...
    switch ($id) {
        case '1'://Lojas por centro
            $sqlGetLojas = "SELECT * FROM ". DATA_CONFIG_BD["cn_tab_lojas_sat_complete"] ." WHERE centro LIKE '$str'";
            $msg = "Lojas " . $str . "";
            break;
        case '2'://Lojas por região
            $sqlGetLojas = "SELECT * FROM ". DATA_CONFIG_BD["cn_tab_lojas_sat_complete"] ." WHERE regiao LIKE '$str'";
            $msg = "Lojas região " . $str . "";
            break;
        case '3'://Lojas por divisão
            $sqlGetLojas = "SELECT * FROM ". DATA_CONFIG_BD["cn_tab_lojas_sat_complete"] ." WHERE divisao LIKE '$str'";
            $msg = "Lojas " . $str . "";
            break;
        default:
        $sqlGetLojas = "SELECT * FROM ". DATA_CONFIG_BD["cn_tab_lojas_sat_complete"] ."";
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <ol class="float-sm-right">
                                        <a href="home.php?token=<?php echo $token;?>">
                                    ...
                                    <div class="card-tools">
                                        <a href="../export/export_lojas_especifica.php?iddash=<?php echo "".$id.""?>&strdash=<?php echo "".$str.""?>" class="btn btn-tool btn-sm">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive-sm">
                                        <table id="tbGetLojas" class="table table-sm table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th>Loja</th>
                                                    <th>Endereço</th>
                                            ...
                                            <?php 
                                                $queryGetLojas = mysqli_query($conn,$sqlGetLojas);
                                                $i=1;
                                                echo "<tbody>";
                                                    while($rowGetLojas = mysqli_fetch_array($queryGetLojas)){
                                                        $numLoja     = $rowGetLojas['loja'];
                                                        $razaoSocial = $rowGetLojas['direFisc'];
                                                        $uf          = $rowGetLojas['codiEstaClie'];
                                                        $cidade      = $rowGetLojas['locaFisc'];
                                                        $cnpj        = $rowGetLojas['codiIden'];
                                                        $cr          = $rowGetLojas['centro'];
                                                        $nTpvs       = $rowGetLojas['n_tpvs_setvari'];
                                                        ...
                                                        echo "<tr>";
                                                            ...
                                                            echo "<td>".$cnpj."</td>";
                                                            echo "<td>".$cr."</td>";
                                                            echo "<td>&nbsp; &nbsp; &nbsp; &nbsp;<a href='#' data-toggle='modal' data-target='#viewDadosSat' data-loja=".$numLoja." data-tpvs=".$nTpvs." data-token=".$token." data-page=".$page." data-id=".$id." data-str=".$str."><i class='fas fa-sitemap'></i></a></td>";
                                                        echo "</tr>";
                                                        $i++;
                                                    }
                                                echo "</tbody>"
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if(data==0){
                                ...
                                modal.find('#link_pdv_'+y).attr('href','getsat.php?token='+token+'&idsat='+sat+'&id='+id+'&str='+str+'&page='+page)
